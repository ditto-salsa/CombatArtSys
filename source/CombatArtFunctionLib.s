...
@ source/CombatArtFunctionLib.c:9:     if ((GetItemAttributes(target->weapon) & IA_MAGICDAMAGE) || (GetItemAttributes(target->weapon) & IA_MAGIC)){
	movs	r6, #72	@ tmp158,
@ source/CombatArtFunctionLib.c:8: void TargetOtherDef(struct BattleUnit* actor, struct BattleUnit* target){
...
@ source/CombatArtFunctionLib.c:9:     if ((GetItemAttributes(target->weapon) & IA_MAGICDAMAGE) || (GetItemAttributes(target->weapon) & IA_MAGIC)){
	...
	bpl	.L2		@,
.L4:
@ source/CombatArtFunctionLib.c:10:         actor->battleDefense += (actor->terrainDefense + actor->unit.def);
	movs	r3, #86	@ tmp163,
@ source/CombatArtFunctionLib.c:10:         actor->battleDefense += (actor->terrainDefense + actor->unit.def);
	movs	r2, #23	@ tmp167,
@ source/CombatArtFunctionLib.c:10:         actor->battleDefense += (actor->terrainDefense + actor->unit.def);
...
@ source/CombatArtFunctionLib.c:11:         actor->battleDefense -= (actor->terrainResistance + actor->unit.res);
	movs	r2, #88	@ tmp174,
@ source/CombatArtFunctionLib.c:11:         actor->battleDefense -= (actor->terrainResistance + actor->unit.res);
	movs	r1, #24	@ tmp178,
@ source/CombatArtFunctionLib.c:11:         actor->battleDefense -= (actor->terrainResistance + actor->unit.res);
...
.L7:
@ source/CombatArtFunctionLib.c:21: }
	@ sp needed	@
@ source/CombatArtFunctionLib.c:14:         actor->battleDefense -= (actor->terrainDefense + actor->unit.def);
...
@ source/CombatArtFunctionLib.c:17:     if (actor->battleDefense < 0)
	mvns	r2, r3	@ tmp215, _25
	asrs	r2, r2, #31	@ tmp219, tmp215,
	ands	r3, r2	@ tmp218, tmp219
@ source/CombatArtFunctionLib.c:18:         actor->battleDefense = 0;
	movs	r2, #92	@ tmp213,
...
@ source/CombatArtFunctionLib.c:9:     if ((GetItemAttributes(target->weapon) & IA_MAGICDAMAGE) || (GetItemAttributes(target->weapon) & IA_MAGIC)){
	...
	bmi	.L4		@,
@ source/CombatArtFunctionLib.c:13:         actor->battleDefense += (actor->terrainResistance + actor->unit.res);
	movs	r3, #88	@ tmp188,
@ source/CombatArtFunctionLib.c:13:         actor->battleDefense += (actor->terrainResistance + actor->unit.res);
	movs	r2, #24	@ tmp192,
@ source/CombatArtFunctionLib.c:13:         actor->battleDefense += (actor->terrainResistance + actor->unit.res);
...
TryDealEffectiveDamage:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	push	{r4, lr}	@
@ source/CombatArtFunctionLib.c:24: void TryDealEffectiveDamage(struct BattleUnit* actor, struct BattleUnit* target, const u8* effectivenessPtr){
	movs	r4, r0	@ actor, actor
@ source/CombatArtFunctionLib.c:25:     if (effectivenessPtr == NULL) return;
	cmp	r2, #0	@ effectivenessPtr,
	beq	.L12		@,
@ source/CombatArtFunctionLib.c:27:     for (; *effectivenessPtr; ++effectivenessPtr){
	ldrb	r3, [r2]	@ _11, *effectivenessPtr_14(D)
	cmp	r3, #0	@ _11,
	beq	.L12		@,
@ source/CombatArtFunctionLib.c:28:         if (*effectivenessPtr == target->unit.pClassData->number){
...
@ source/CombatArtFunctionLib.c:28:         if (*effectivenessPtr == target->unit.pClassData->number){
	cmp	r1, r3	@ _2, _11
	bne	.L14		@,
@ source/CombatArtFunctionLib.c:29:             actor->battleAttack += GetItemMight(actor->weapon) * 2;
	movs	r3, #72	@ tmp130,
@ source/CombatArtFunctionLib.c:29:             actor->battleAttack += GetItemMight(actor->weapon) * 2;
	ldrh	r0, [r4, r3]	@ _4,
	ldr	r3, .L23	@ tmp132,
...
.L12:
@ source/CombatArtFunctionLib.c:35: }
	@ sp needed	@
	pop	{r4}
	pop	{r0}
	bx	r0
